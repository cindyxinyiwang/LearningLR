...
\icmlauthor{Xinyi Wang}{equal,cmu}
\icmlauthor{Hieu Pham}{equal,cmu,goo}
\icmlauthor{Paul Michel}{cmu}
\icmlauthor{Antonios Anastasopoulos}{cmu}
\icmlauthor{Jaime Carbonell}{cmu}
\icmlauthor{Graham Neubig}{cmu}
\end{icmlauthorlist}

\icmlaffiliation{cmu}{Language Technology Institute, Carnegie Mellon University, Pittsburgh, PA 15213, USA}
\icmlaffiliation{goo}{Google Research, Brain Team, Mountain View, CA 94043, USA}

\icmlcorrespondingauthor{Xinyi Wang, Hieu Pham}{\{xinyiw1,hyhieu\}@cs.cmu.edu}
...
\input{abstract_iclr.tex}
\input{introduction_iclr.tex}
\input{method_iclr.tex}
