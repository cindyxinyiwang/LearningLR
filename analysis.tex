...
DDS, with or without initialization with the heuristic distribution from TCS, allows the model to reach lower dev perplexity than TCS for all 4 languages. We didn't plot Uniform here because it takes much longer training steps to converge, and thus has very noisy trend.
